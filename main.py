...
def add_item():
  if (part_text.get()== None or customer_text.get() == '' or retailer_text.get() == None or price_text.get() == None):
    messagebox.showerror('plz input all fields')
    return
  else:
...
parts_list.grid(row=3,column=0,columnspan=5,padx=30,pady=20)
